...
export default function ProductBag({ product, bagItem }: { product: Product, bagItem: BagItem }) {
  return (
      ...
      <div className="flex flex-col relative gap-1 overflow-hidden">
        ...
        <div className="flex justify-between items-center">
          <div className="flex flex-col gap-1">
            <span className="text-xs uppercase font-semibold">Size {product.sizes}</span>
            <span className="text-xs uppercase font-semibold">Qty: {bagItem.quantity}</span>
          </div>
