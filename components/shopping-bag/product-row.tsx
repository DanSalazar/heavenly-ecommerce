...
export default function ProductRow({ product }: { product: Product }) {
    ...
    <div className="relative border-b border-t border-zinc-200 py-4 flex flex-col md:flex-row gap-4">
      <Image className="self-center" src={product.img_src} width={180} height={230} alt={product.title} />
      <div className="col-span-2 flex flex-col gap-2 overflow-hidden">
        <Link href={'/'} className="font-medium text-zinc-700 hover:text-black truncate">
          {product.title}
        </Link>
